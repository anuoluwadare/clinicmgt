...
class ADODB_Pager {
	...
	var $gridAttributes = 'class="tbldata"';
	...
	var $htmlSpecialChars = false;//changed to false by Bisi 
	var $page = 'Page';
	...
	global $ADODB_COUNTRECS;
		...
		$this->rs = &$rs;
		if (!$rs) {
			print "<h1>Query failed: $this->sql</h1>";
			return;
		}
	...
	function RenderLayout($header,$grid,$footer,$attributes='class=tbldata')
	{
