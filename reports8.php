...
@$action=$_POST['Submit'];
if ($action=='Go!') {
	$sql="select round(avg(TIME_FORMAT(subtime(time,timein),'%i')),0) as diff from calls  
 ";
...
<table width="100%" border="0">
  <tr>
    <td align="center" valign="top"><table width="600" border="0">
      ...
      <tr>
        <td><form method="post" action="reports8.php" >
          <table width="100%" border="0">
            <tr>
              <td height="39" class="article-title">Reports -&gt;Average time patient waits for a nurse</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
